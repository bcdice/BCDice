  ...
  module GameSystem
    class ShinobiGami < Base
      ...
      HELP_MESSAGE = <<~INFO_MESSAGE_TEXT
        ...
        ＞流派ブック以降
        時の流れ KRAT、竜虎相博 KRRS、切神ラボ HGKL、不良高校 OTFK
        ・D66ダイスあり
      INFO_MESSAGE_TEXT
      ...
      SCENE_TABLES = {
        ...
        'KRAT' => DiceTable::Table.new(
          '時の流れシーン表',
          '1D6',
          [
            '受験勉強。こんな経験はしたことがない。忍者の修行より厳しいかもしれない。≪記憶術≫で判定を行う。',
            '文化祭。なぜかバンドの一員としてライブをすることに……。≪遊芸≫で判定を行う。',
            '相談。あいつが好きな人について相談してくる。それって、もしかして……?≪伝達術≫で判定を行う。',
            '体育祭。目立つのはまずいんだが……。≪走法≫で判定を行う。',
            '帰り道。たまたま、あいつと一緒になる。どこからか漂ういい香りに腹の音が……。≪経済力≫で判定を行う。',
            'ハプニング。授業中、教室に奇妙な動物が入り込んできた！≪鳥獣術≫で判定を行う。'
          ]
        ),
        'KRRS' => DiceTable::Table.new(
          '竜虎相博シーン表',
          '2D6',
          [
            'むせ返るほどに濃い血の匂いが立ち込めている。殺された者たちの、痛み、苦しみ、怨嗟の声が身体にまとわりつくようだ。',
            'カラスの群れが不快な鳴き声をあげる。無造作に突き立てられた刃は誰の墓標だろうか。死して屍拾う者なし。',
            'びょうびょうと風が吹き付ける。かつての剣豪たちの修行場だろうか、無数の剣撃の跡の残る巨岩を飲み込むように、大樹の根が覆っている。',
            '壁が倒れ、天井が崩れ落ちた仏堂。朽ち果てた仁王像を薄い月明かりが照らしている。その顔に浮かぶは、怒りか憐れみか。',
            '人が足を踏み入れるのを拒むかのように巨木が生い茂る古き森。木々は何を隠そうとしているのだろうか。',
            '朱塗りの橋のたもとに、誰かが立っている。この世とあの世を繋ぐ三途の川の渡し守だろうか。',
            '静謐な竹林。風がやみ、無音の時が流れる。明鏡止水。',
            '大小様々な大きさの地蔵が並んでいる。手入れをするものがいないのか、苔むし、無惨に砕け散ったものも多い。',
            'あかね色の鳥居が無数に立ち並ぶ古道。弱き者は神にすがり、強き者は神に挑む。',
            '森の中に不意に現れた簡素な庵。誰が住んでいるかは分からぬが、焚き付けた香のかおりが微かに残っている。',
            '青々とした木々がざわめき、滝の音が響き渡る。水しぶきの中に小さく虹がかかり、一瞬だけ殺伐とした現実を忘れさせてくれる。'
          ]
        ),
        'HGKL' => DiceTable::Table.new(
          '切神ラボシーン表',
          '2D6',
          [
            '警報装置が鳴り響く。徘徊する斜歯の警護ロボットに見つかると面倒だ。やり過ごそう。',
            'いくら歩いても同じ通路、同じ部屋へと戻ってくる。一体誰が仕掛けた罠なのか。',
            '通気孔を通って研究所の奥へと進む。見つからなければよいが……。',
            '規則正しく並べられた培養槽には見知った顔のホムンクルスが浮かんでいる。意識はないようだが……。',
            'チリ一つ落ちてない廊下が続く。あなたの望むモノは本当にこの先にあるのだろうか。',
            '研究所の一室に入り込む。入る所は誰にも見られなかったはず。',
            '戦闘訓練用に作られた巨大な空間。様々な計器が周囲に取り付けられている。少しぐらい暴れても壊れることはなさそうだ。',
            '水槽に浮かぶ巨大な魚影。複数の眼と鰓の脇についた小さな人の手のようなものを絶え間なく動かす姿はとても醜悪だ。',
            'セキュリティの厳重なコンピュータールーム。薄暗い部屋の中でモニターやランプの灯りが明滅を繰り返す。',
            '警備室。監視カメラの映像が所狭しと並んでいる。',
            'カツ―ン、カツ―ン。規則正しく釘えを木に打ち付ける音がする。斜歯による全自動丑の刻参り機は絶え間なく呪詛をまき散らしている。'
          ]
        ),
      }.freeze
