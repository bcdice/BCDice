    ...
    class KillDeathBusiness < Base
      ...
      def getExtraTableResult(type)
        ...
        extraTable1 = [
          ...
          [46, "普通の"],
          [55, "変身ヒーローの正体である"],
          [56, lambda { "『#{getNameTableResult(0)[1]}』の異名を持つ" }],
          [66, "歴史上の人物だが実は生きていた"],
        ]
        extraTable2 = [
          [11, "サラリーマン"],
