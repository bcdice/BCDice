  ...
  module GameSystem
    class Satasupe < Base
      ...
      CREATE_ARMS_ACCESSORY_TABLE = {
        ...
        16 => ["「捻子やビス」", "「ダメージ＋１」", lambda { |arm, _r| arm.damage += 1 }].freeze,
        22 => ["「生ゴミ」", "「衝撃」", lambda { |arm, _r| arm.abilities << "「衝撃」" }].freeze,
        23 => ["「ゴム」", "「ダメージ＋１」", lambda { |arm, _r| arm.damage += 1 }].freeze,
        24 => ["「歯車」", "「リボルバー」", lambda { |arm, _r| arm.abilities << "「リボルバー」" }].freeze,
        25 => ["「歯や牙、骨」", "「（判定前宣言）1D6回、ダメージ＋２」", lambda { |arm, r| arm.kiba = r.roll_once(6) }].freeze,
        26 => ["「ワイヤー」", "「耐久度＋１」", lambda { |arm, _r| arm.life += 1 }].freeze,
        33 => ["「メガネなどのレンズ」", "「命中－１」", lambda { |arm, _r| arm.hit -= 1 }].freeze,
        34 => ["「マッチ」", "「必殺12」", lambda { |arm, _r| arm.abilities << "「必殺12」" }].freeze,
        35 => ["「ガムテープや接着剤」", "「耐久度＋１」", lambda { |arm, _r| arm.life += 1 }].freeze,
        36 => ["「洗濯ばさみ」", "「命中－１」", lambda { |arm, _r| arm.hit -= 1 }].freeze,
        ...
        55 => ["「エアコンプレッサ」", "「ダメージ＋１」", lambda { |arm, _r| arm.damage += 1 }].freeze,
