  ...
  module GameSystem
    class ShinkuuGakuen < Base
      ...
      def getWeaponTableStand
        {name: '幽波紋',
         table: [[11, 'SILER CHARIOT', '攻撃量５倍、刺しタイプ攻撃'],
      ...
      def getWeaponTableStandCounter
        {name: '幽波紋カウンター',
         table: [[11, 'ANUBIS', '技のみカウンター、ダメージ（カウンターした回数の２乗）倍、斬りタイプ攻撃'],
                 [22, nil, nil],
                 [33, nil, nil],
                 [44, nil, nil],
                 [55, nil, nil],
