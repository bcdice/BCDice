...
module BCDice
  module GameSystem
    class StellarKnights < Base
      ...
      THEME_TABLE = [
        ['未来', '占い', '遠雷', '恋心', '歯磨き', '鏡'].freeze,
        ['過去', 'キス', 'ささやき声', '黒い感情', 'だっこ', '青空'].freeze,
        ['童話', '決意', '風の音', '愛情', '寝顔', '鎖'].freeze,
        ['ふたりの秘密', 'アクシデント！', '小鳥の鳴き声', '笑顔', '食事', '宝石'].freeze,
        ['思い出', 'うとうと', '鼓動', '嫉妬', 'ベッド', '泥'].freeze,
        ['恋の話', 'デート', 'ため息', '内緒話', 'お風呂', '小さな傷'].freeze,
      ].freeze

      SITUATION_TABLE_A = ['朝、誰もいない', '騒がしい昼間の', '寂しい夕暮れの横たわる', '星の瞬く夜、', '静謐の夜更けに包まれた', '夜明け前の'].freeze
      ...
      SITUATION_TABLE_B2_1 = ['地下のだだっぴろい学食', 'パンの種類が豊富な購買の前', '本当は進入禁止の屋上', 'キャンプ部が手入れしている中庭', '共用の広いグラウンド', '使い古された教室'].freeze

      SITUATION_TABLE_B2_2 = ['（美術ｏｒ音楽）準備室', '美しく整備された中庭', '音楽室', '格調高いカフェテラス', '誰もいない大型劇場', '完璧な調和を感じる温室'].freeze

      SITUATION_TABLE_B2_3 = ['中庭の神殿めいた温室', '質素だが美しい会食室', '天井まで届く本棚の並ぶ図書館', '誰もいない学習室', '寮生たちの秘密のお茶会室', '寮の廊下'].freeze

      SITUATION_TABLE_B2_4 = ['遠く聞こえる爆発音', '学生のアンケート調査を受ける', '空から降ってくるドローン', '膨大な蔵書を備えた閉架書庫', '鳴らすと留年するという小さな鐘の前', '木漏れ日のあたたかな森'].freeze

      SITUATION_TABLE_B2_5 = ['おしゃれなカフェテラス', '小さなプラネタリウム', 'ローマの神殿めいた屋内プール', '誰もいない講堂', '謎のおしゃれな空き部屋', '花々の咲き乱れる温室'].freeze

      SITUATION_TABLE_B2_6 = ['人気のない教室', '歴代の寄せ書きの刻まれた校門前', '珍しく人気のない学食', '鍵の外れっぱなしの屋上', '校舎裏', '外周環状道路へ繋がる橋'].freeze
      ...
      PERSONALITY_TABLE = ['可憐', '冷静', '勇敢', '楽観主義', '負けず嫌い', 'コレクター気質', 'クール', '癒やし系', '惚れやすい', '悲観主義', '泣きやすい', 'お嬢様', '純粋', '頑固', '辛辣', 'まじめ', '落ち込みやすい', '謙虚', 'スマート', 'ゆるふわ', '好奇心旺盛', 'はらぺこ', '華麗', '狭いところが好き', '冷徹', '朴念仁', '王子様', '目立ちたがり', '過激', 'マゾヒスト', 'ダンディ', 'あらあらうふふ', '過保護', '死にたがり', '強い自尊心', 'サディスト'].freeze
      ...
      FRAGMENT_TABLE = ['出会い', '水族館', '動物園', '絵本', '童話', '神話', '怒った', '笑った', '泣いた', '好き', '愛情', '憎悪', '寒い', '暑い', '甘い', '苦い', 'お菓子', '路地', '部屋', '身体', 'ぬくもり', '毛布', '空想', '願い', '笑顔', '味覚', '映画', '朗読', 'うた', '音楽', '視力', '肌の色', '聴力', '声', '痛覚', '触覚'].freeze
