...
module BCDice
  module GameSystem
    class MagicaLogia < Base
      ...
      SKILL_TABLE = DiceTable::SaiFicSkillTable.new(
        [
      ...
      # ブランク秘密表用テーブル
      INVETERATE_ENEMY_TABLE = SkillExpandTable.new(
        "宿敵表",
        "1D6",
        [
          '嫉妬。その人物は、実は調査者の実力をねたむ〈大法典〉の魔法使いだった。データは〈火刑人〉を使用する。ただし、魔法の使用には魔素を必要とし、魔法使いをコレクションすることはできない。GMは調査者やそのアンカーに魔法戦を挑み、邪魔をするように操作すること。',
          '蒐集。その人物は、実は調査者をコレクションしようとする〈書籍卿〉だった。データは〈混血主義者〉を使用する。GMは〈断章〉に立ち会ったり、魔法戦を挑んだりして、調査者の邪魔をするように操作すること。',
          '妨害。その人物は、実は現在調査者が追っている〈断章〉を奪おうとする〈書籍卿〉だった。データは〈囁きの誘惑者〉を使用する。GMは〈断章〉に立ち会ったり、魔法戦を挑んだりして、調査者の邪魔をするように操作すること。',
          "断章。その人物には、今回の件と関係ない〈断章〉が憑依していた。データは〈猛獣〉を使用する。ただし特技と召喚する騎士は%<skill>sに変更する。GMは〈断章〉に立ち会ったり、魔法戦を挑んだりして、調査者の邪魔するように操作すること。",
          '黒服。その人物は、実は魔法やオバケなどのあらゆる超常現象を否定する秘密結社「サークルエンド」の工作員だった。データは〈サークルエンド〉を使用する。GMは【隠蔽工作】を使用したり、魔法戦を挑んだりして、調査者の邪魔をするように操作すること。',
          '忍者。その人物は、実はあなたを殺せという使命を受けた忍者である。データは〈忍者〉を使用する。GMは〈断章〉に立ち会ったり、魔法戦を挑んだりして、調査者の邪魔をするようにそうさすること。',
        ]
      )

      CONSPIRACY_TABLE = DiceTable::Table.new(
        "謀略表",
        "1D6",
        [
      ...
      FATE_TABLE = DiceTable::Table.new(
        "因縁表",
        "1D6",
        [
      ...
      CUEBALL_TABLE = DiceTable::Table.new(
        "奇人表",
        "1D6",
        [
      ...
      FORCE_FIELD_TABLE = DiceTable::Table.new(
        "力場表",
        "1D6",
        [
      ...
      ALLIANCE_TABLE = SkillExpandTable.new(
        "同盟表",
        "1D6",
        [
          "精霊。その人物は、実は姿を変え、人間界に顕現した精霊だった。象徴する特技は%<skill>sである。調査者は、そのセッションの間だけ、その特技の【精霊召喚】を修得する。また、セッションに一度だけ、その【精霊召喚】の判定を自動的に成功にすることができる。",
          "騎士。その人物は、実は姿を変え、人間界に顕現した騎士だった。象徴する特技は%<skill>sである。調査者は、そのセッションの間だけ、その特技の【騎士召喚】を修得する。また、セッションに一度だけ、その【騎士召喚】の判定を自動的に成功にすることができる。",
          "魔王。その人物は、実は姿を変え、人間界に顕現した魔王だった。象徴する特技は%<skill>sである。調査者は、そのセッションの間だけ、その特技の【魔王召喚】を修得する。また、セッションに一度だけ、その【魔王召喚】の判定を自動的に成功にすることができる。",
          '魔法屋。その人物は、魔法の道具を取引するタリスモンガーだった。以降、この人物のいるシーンでは、自分のチャージしている魔素1つを別の魔素1つに交換してもらうことができる。また、この人物のいるシーンでは、自分の装備魔法1つを修得可能な別の装備魔法1つに交換してもらうことができる。',
          '師匠。その人物は、かつて調査者に魔法を教えた師匠だった。以降、この人物のいるシーンでは、自分の修得している特技1つを修得可能な別の特技1つに交換してもらうことができる。また、この人物のいるシーンでは、自分の呪文魔法1つを修得可能な別の呪文魔法1つに交換してもらうことができる。',
          '無垢。その人物は、汚れ無き心の持ち主だった。このNPCは、プライズとして扱う。このプライズの持ち主は、セッション中に一度、【浄化】の呪文をコストなしで使用することができる。この判定は自動的に成功する。',
        ]
      )

      TABLES = {
        "TPT" => SkillExpandTable.new(
          "時の流れ表",
          "1D6",
          [
            "標的となり追われる生活が続いた。ここ数年は苦しい戦いの日々だった。%<skill>sの判定を行う。成功するとセッション終了時に追加の功績点1点。失敗すると「運命変転」発生。",
            "冒険の日々の途中、大きな幸せが訪れる。%<skill>sの判定を行う。成功すると、自分のアンカーの災厄か、自分の疵一つを無効化する。",
            "瞑想から目を覚ます。もうそんな時間か。おかげで十分な魔素を得ることができた。「%<element>s」「%<element>s」「%<element>s」の魔素を獲得する。",
            "傷を癒すには十分な時間だ。自分の【魔力】を最大値まで回復する。もしくは「魔力のリセット」を行うことができる。好きな方を選ぶこと。",
            "平穏な日々の中にも、ちょっとした事件が起きる。自分のアンカーを一人選んで「事件表」を振ることができる。",
            "日々研鑚を重ね、魔法の修行に精進した。もしも望むなら、蔵書欄にある魔法を、自分の修得できる範囲の中で、現在とは別の魔法に変更して構わない。もしも、魔素がチャージされていた魔法を見習得にした場合、その魔素は失われる。",
          ]
        ),
        "ST" => SkillExpandTable.new(
          "シーン表",
          "2D6",
          [
            ...
            "周囲で〈断章〉が引き起こした魔法災厄が発生する。%<skill>sの判定を行うこと。成功すると、好きな魔素が一個発生する。失敗すると「運命変転表」を使用する。",
        ...
        "WT" => SkillExpandTable.new(
          ...
          [
            ...
            "『病魔』【防御力】が1点減少する。",
            "『遮蔽』【根源力】が1点減少する",
            "『不運』%<skill>sのチェック欄をチェックする。その特技が使用不能になり、その分野の特技が指定特技になった判定を行うとき、マイナス1の修正が付く。",
          ]
        ),
        "FCT" => DiceTable::Table.new(
          "運命変転表",
          "1D6",
          [
        ...
        "AT" => SkillExpandTable.new(
          ...
          [
            ...
            "生ける屍の群れ、地獄の業火、迷宮化……魔法災厄に襲われる。%<skill>sの判定を行う。成功すると好きな魔素が1点発生する。失敗すると、その人物に対し「運命変転表」を使用する。",
        ...
        "XEST" => SkillExpandTable.new(
          ...
          [
            ...
            "苛酷な自然環境によってキミたちは窮地に立たされる。%<skill>sの判定を行うこと。成功すると、なんとか使えそうなものを探し、好きな魔素が一個発生する。失敗すると、キミの負った傷は時間と空間を超えて、キミのアンカーに不幸をもたらす。「運命変転」が発生する。",
        ...
        "IWST" => SkillExpandTable.new(
          ...
          [
            ...
            "夜の道。もやもやと黒いものが後ろから、追いかけてくる。はっきりした姿も分からないのに、ひどく恐ろしく感じる。このシーンに登場するPCは、%<skill>sの判定を行う。成功すると、好きな魔素二個を獲得できる。失敗した場合、もやもやとした黒いものは君のアンカーの前に現れる。「運命変転」が発生する。",
            '夕暮れの街。なんだか寂しい気分になる。',
        ...
        "MCST" => SkillExpandTable.new(
          ...
          [
            ...
            "広場。魔法使い同士が喧嘩を始め、魔法が飛び交い始める。このシーンに登場したPCは、%<skill>sで判定を行う。成功すると、好きな魔素を二個獲得する。失敗すると、この場所の魔法の影響が時空を超えて、アンカーに現れる。「運命変転」が発生する。",
        ...
        "WDST" => SkillExpandTable.new(
          ...
          [
            ...
            "床が白い雲になっている場所。雲の隙間からは、現世のような風景が見える。%<skill>sの判定を行う。成功すると、このセッション中一度だけ、判定のサイコロを振り直すことができる。失敗すると、時空を越えて、アンカーが死後世界を垣間見てしまう。「運命変転」が発生する。",
        ...
        "LWST" => SkillExpandTable.new(
          ...
          [
            ...
            "怪物が現れ、キミたちを襲う。このシーンに登場しているPC全員は、%<skill>sの判定を行うこと。成功すると、怪物を倒し、好きな魔素が一個発生する。失敗すると、キミの負った傷は時間と空間を越えて、キミのアンカーに不幸をもたらす。「運命変転」が発生する。",
        ...
        "STB" => SkillExpandTable.new(
          ...
          [
            ...
            '静かなカフェの店内。珈琲の香りと共に、優しく穏やかな雰囲気が満ちている。',
            '無人の路地裏。ここならば、邪魔が入ることもないだろう。',
            "周囲で〈断章〉が引き起こした魔法災厄が発生する。%<skill>sの判定を行うこと。成功すると、そのシーンに好きな魔素が1点発生する。失敗すると、「運命変転表」を使用する。",
        ...
        "MBST" => SkillExpandTable.new(
          "魔法書架シーン表",
          "2D6",
          [
            "〈禁書〉の保管庫へ入ることを許可された。幾重にも張り巡らされた決壊や、鋭い目つきの書警たちが目に付く。その隙をついて、〈禁書〉が襲い掛かってきた！このシーンに登場したPCは一人だけ《%<force>s》の判定を行う。失敗すると、【魔力】が3点減少する。成功すると、【一時的魔力】を3点得る。誰かが判定すると、成否にかかわらず、この効果はなくなる。",
            ...
            "荒れ果てた部屋。倒れた空っぽの本棚が、目に付く。これは〈大破壊〉の影響なのだろうか…。このシーンに登場するPCは、%<skill>sの判定を行う。失敗すると、時空を超えてアンカーに影響が現れる。「運命変転」が発生する。",
            ...
            "魔導書の閲覧室。数人の魔法使いが、熱心に魔導書を読んでいる。このシーンに登場しているPCのうち一人は、%<skill>sの判定を行うことができる。成功すると、修得している魔法を一つ、修得可能な別の魔法に入れ替えることができる。失敗すると、「封印」の変調を受ける。誰かが判定すると、成否にかかわらず、この効果はなくなる。",
            '本棚と本棚の間に、唐突に扉が浮かんでいる。この扉は、異界につながる戸口だ。一体どこにつながっているのだろう。異界シーン表の中からランダムに一つを選んで、その効果を適用する。',
          ]
        ),
        "MAST" => SkillExpandTable.new(
          "魔法学院シーン表",
          "2D6",
          [
            '目の前に美しい黒龍が現れた。学院の長、ザナルパトスだ。彼は、何を告げようとしているのだろうか。',
            "突然何かが襲い掛かってきた！生徒が元型の召喚に失敗したようだ。このシーンに登場しているPCのうち一人は、≪%<force>s≫の判定を行う。失敗すると、【魔力】が3点減少する。成功すると、【一時的魔力】を3点得る。誰かが判定すると、成否にかかわらず、この効果はなくなる。",
            "ここは女子寮？このシーンに男性のPCが登場した場合、その男性PCは≪%<beast>s≫の判定を行う。失敗すると、「封印」の変調を受ける。",
            ...
            "扉を開けて現れたのは、よく知る相手だった。なぜか、学院に迷い込んでしまったようだ。%<skill>sで判定を行う。失敗すると、「運命変転」が発生する。",
            '誰かが作った秘密の小部屋に迷い込んでしまう。学院ではあまり食べられないお菓子が山のように仕舞われているようだ。',
            '学院西部に広がるアーデンの森。鳥の鳴き声が聞こえる。',
            "授業を行っている教室。講師が呼び出した元型がこちらに向かって飛んでくる。このシーンに登場しているPCは一人だけ%<skill>sで判定を行う。失敗すると【魔力】が1点減少する。成功すると、その特技の精霊が召喚できる。誰かが判定すると、成否にかかわらず、この効果はなくなる。",
            "生徒に何か魔法を見せて欲しいと乞われる。このシーンに登場しているPCは一人だけ、≪%<dream>s≫の判定を行う。失敗すると、「不運」の変調を受ける。成功すると、「夢」の魔素をを2点獲得する。誰かが判定すると、成否にかかわらず、この効果はなくなる。",
            "自習室。生徒たちが必死に魔導書を理解しようとしている。このシーンに登場しているPCは一人だけ、≪%<star>s≫の判定を行う。成功すると、好きな魔素をを2点獲得する。誰かが判定すると、成否にかかわらず、この効果はなくなる。",
          ]
        ),
        "TCST" => SkillExpandTable.new(
          "クレドの塔シーン表",
          "2D6",
          [
            '目の前に一人の少女が現れる。眠り姫の長、ラトゥナだ。ずっと眠り続けている筈の彼女が現れたのは、いったい何を告げるためなのだろうか。',
            "突然何かが襲い掛かってきた！未熟な魔法使いが元型の召喚に失敗したようだ。このシーンに登場しているPCは一人だけ、≪%<force>s≫の判定を行う。失敗すると、【魔力】が3点減少する。成功すると、【一時的魔力】を3点得る。誰かが判定すると、成否にかかわらず、この効果はなくなる。",
            "話しかけてきた天涯預言者が、不幸な未来を予言する。このシーンに登場しているPCは一人だけ、≪%<dream>s≫の判定を行う。失敗すると、【魔力】が1点減少する。成功すると、「夢」の魔素をを1点獲得する。誰かが判定すると、成否にかかわらず、この効果はなくなる。",
            ...
            "こんな場所にいる筈のない人が君の前にあらわれる。眠り姫の眠りの中に迷い込んでしまったらしい。%<skill>sで判定を行う。失敗すると、「運命変転」が発生する。",
        ...
        "PWST" => SkillExpandTable.new(
          "並行世界シーン表",
          "2D6",
          [
            'カフェのテーブル。FMラジオは、去年解散したはずのバンドの、先日発表した新曲を流している。このシーンに登場しているPCのうち一人は、「時の流れ表」を1回振り、効果を適用する。',
            "賑やかな通り。向こうから、あなたにそっくりな人物が歩いてくる。あれはこの世界の、あなた自身だろうか。このシーンに登場しているPCの一人は、%<skill>sの判定を行う。成功すると、好きな魔素をを2点獲得する。失敗すると、「病魔」の変調を受ける。誰かが判定すると、成否にかかわらず、この効果はなくなる。",
        ...
        "PAST" => SkillExpandTable.new(
          ...
          [
            ...
            "夜。もはや廃墟と化した埃っぽい都市。〈愚者〉が虚憑に襲われている。このシーンに登場しているPCの一人は、%<skill>sの判定することができる。成功すれば救出でき、助け出した〈愚者〉に対し、好きな属性で運命を1点獲得する。失敗すると【魔力】を3点失う。",
        ...
        "GBST" => SkillExpandTable.new(
          ...
          [
            ...
            "客の一人に、無理矢理酒を飲まされる。なんて強い酒だろう。%<skill>sで判定を行う。失敗すると、「運命変転」が発生する。",
        ...
        "SLST" => SkillExpandTable.new(
          ...
          [
            ...
            "「この席、よろしいかな？」あなたの隣に〈書籍卿〉が座る。%<skill>sの判定に成功すると公開されているハンドアウトの中から、好きなものを選び、その【秘密】を公開することができる。誰かが判定すると、成否にかかわらず、この効果はなくなる。",
        ...
        "WMT" => SkillExpandTable.new(
          "さまよう怪物表",
          "1D6",
          [
            "トロールに率いられたオークとゴブリンの大軍団に遭遇する。数百という怪物たちが野蛮な叫び声をあげながら、魔法使いたちに襲い掛かってくる。≪%<star>s≫の判定を行う。全員の判定が終わったら、失敗したPCは1d6点のダメージを受ける。このとき、判定に成功したPCの数だけそのダメージの値を軽減できる。",
            "大きな猛牛の頭をした巨漢…ミノタウロスが立ち塞がる。手に持った青銅の斧を振りかぶる。シーンに登場しているPCの中からランダムに代表を1人選ぶ。代表は≪%<beast>s≫の判定を行う。失敗すると、PC全員は2点のダメージと「綻び」の変調を受ける。",
            "突如、ドラゴンが現れる。深紅の鱗に覆われた巨影は、鎌首をもたげると、数瞬後、強烈な炎を吐いた。シーンに登場しているPC全員は≪%<force>s≫の判定を行う。全員の判定が終わったら、PC全員は、1+判定に失敗した人数点のダメージを受ける。",
            "白銀の鎧に身を包んだ騎士が現れる。騎士は一対一の勝負を挑んできた。シーンに登場しているPCの中から代表を1人選ぶ。代表は≪%<poem>s≫の判定を行う。失敗すると代表は5点のダメージを受ける。",
            "美しい上半身と獣の下半身を持つ女怪が現れる。艶めかしくその体をくゆらせながら、手を差し出してくる。シーンに登場しているPC全員は≪%<dream>s≫の判定を行う。失敗したPCは、3点のダメージを受け、好きな魔素を3点失う。",
            "黒いローブをまとった幽鬼が現れる。枯れ木のような細い腕を振り上げて、勇気は呪いの言葉を叫ぶ。幽鬼の【魔力】は4点。シーンに登場しているPC全員は≪%<night>s≫の判定を行う。失敗したPCは、「不幸」の変調を受け、運命変転が発生する。",
          ]
        ),
        "FFT" => DiceTable::Table.new(
          "落花表",
          "1D6",
          [
        ...
        "OLST" => SkillExpandTable.new(
          "旧図書館シーン表",
          "2D6",
          [
            "曲がり角。唐突に〈禁書〉が現れ、襲いかかってきた！このシーンに登場するPCは、%<skill>sで判定を行う。失敗すると、【魔力】を3点失う。",
            ...
            "破壊された魔導書が、山のように積み重なる場所。本の山に隠れていた〈断章〉が襲い掛かってくる。このシーンに登場するPCは、%<skill>sで判定を行う。成功すると、〈断章〉を倒し、好きな魔素を一個手に入れる。失敗すると、時空を超えてアンカーに影響が現れる。「運命変転」が発生する。",
            ...
            "どこからか湧き出した水が、床の上に泉を作っている場所。泉の上に何者かの呼び出した元型が浮かんでいる。%<skill>sで判定を行う。成功すると、【一時的魔力】を1点手に入れる。失敗すると、攻撃され、【魔力】が1点減少する。誰かが判定すると、成否にかかわらず、この効果はなくなる。",
            'なぜ、君がここに？扉を開けると、そこにはPCのアンカーがいた。シーンプレイヤーのアンカーの中から、ランダムに一人を選ぶ。そのアンカーが登場する。シーンプレイヤーは、そのアンカーに「事件」を行っても、行動済みにならない。',
          ]
        ),
        "TPTB" => SkillExpandTable.new(
          "大判時の流れ表",
          "1D6",
          [
            "波乱万丈の人生を送る。この時代に起きた有名な事件の背後では、多くの魔法的存在が暗躍していた。あなたも、その事件に関わり、〈禁書〉や〈書籍卿〉たちと戦いを繰り広げる。%<skill>sの判定を行う。成功するとセッション終了時に追加で功績点を1点獲得する。失敗すると、自分に「運命変転」が発生する。",
            "冒険の日々の途中、大きな幸せがおとずれる。%<skill>sの判定を行う。成功すると、自分のアンカーが負っている不幸か、自分が負っている疵一つを無効化する。",
