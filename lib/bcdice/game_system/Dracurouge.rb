  ...
  module GameSystem
    class Dracurouge < Base
      ...
      def getReactionDiceCommandResult(command)
        ...
        return getReactionText(name, typeText1, typeText2, REACTION_INFO_BLOOD, REACTION_INFO_STYLE)
      end
      ...
      def getHeresyReactionDiceCommandResult(command)
        ...
        return getReactionText(name, typeText1, typeText2, HERESY_REACTION_INFO_BLOOD, HERESY_REACTION_INFO_STYLE)
      end
      ...
      def checkTypeText(typeText, infos)
        ...
        return infos.keys.include?(typeText)
      end
