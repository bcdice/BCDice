  ...
  module GameSystem
    class GardenOrderReEdit < GardenOrder
      ...
      def eval_game_system_specific_command(command)
        ...
        when /^(DC|SD)(SL|BL|IM|BR|RF|EL)(\d+)/i
          chart_type = Regexp.last_match(1)
          type = Regexp.last_match(2)
          damage_value = Regexp.last_match(3).to_i
          return look_up_damage_chart(chart_type, type, damage_value)
        end

        return nil
      end

      def look_up_damage_chart(chart_type, type, damage_value)
        chart_str = ""
        case chart_type
        when "DC"
          chart_str = "通常"
