  ...
  module GameSystem
    class CyberpunkRed < Base
      ...
      TABLES = {
        ...
        "NCNT" => DiceTable::RangeTable.new(
          "ナイトシティにおける夜間の遭遇",
          "1D100",
          [
            [1..5, "市警察 ＞ PCグループの半分の人数の巡回警官。P.419参照。"],
            [6..11, "企業の警備員 ＞ この地区をパトロールしている、企業の警備員。PCグループと同じ人数。。P.420参照。"],
            [12..13, "企業所属のテク ＞ 企業所属の技術者(人数はPCの半分)と、重武装のボディガードたち(人数はPCの半分)。P.420参照。"],
            [14..17, "私立探偵 ＞ 1人の私立探偵。P.420参照。"],
            [18..20, "企業の社員 ＞ 大企業の社員が、磁気浮上式鉄道の駅へ向かっている。人数はPCと同数。P.420参照。"],
            [21..25, "ロッカーボーイ ＞ ギグに向かう途中のロッカーのグループ。PCたちは前方にいるグループに追いつきつつある。P.420参照。"],
            [26..30, "メディア ＞ カメラとインタビュアーの2人組のメディア。特ダネを求めて1軒の建物に張り込みしている。P.420参照。"],
            [31..33, "フィルハーモニック・ヴァンパイアズ ＞ 音楽愛好吸血鬼団というギャングが、またもや騒動を巻き起こしている。P.421参照。"],
            [34..40, "地元民 ＞ ビーバーウィルから来たティーンエイジャー1人。たぶん内緒でシティ見物に来たんだろう。P.421参照。"],
            [41..46, "下見中のネットランナー ＞ 超大型拳銃で武装し、軽装アーマージャックを着込んだ2人のネットランナー。P.421参照。"],
            [47..52, "ノーマッド ＞ ロードランナーズ・パック所属のノーマッドの一団(人数はPCと同じ)。P.421参照。"],
            [53..58, "ストリート・パンク ＞ 合成麻薬飲料中毒者どもが、飲み代を稼ごうとカモを探している(人数はPCと同数)。P.421参照。"],
            [59..63, "トラウマ・チーム ＞ AV-4が銃撃戦の真っ只中に強行着陸し、降りて来たメディックたちが、負傷した6人ほどのギャンガーたちに応急処置を施しはじめる。P.421参照。"],
            [64..69, "クローマー ＞ 地元のクロマティック・ロック・バンドの筋金入りのファンの一団。P.421参照。"],
            [70..72, "ソロのチーム ＞ PCグループの半分の人数のソロの一団。P.421参照。"],
            [73..77, "ブースターギャング ＞ PCグループと同人数の、アイアン・サイツというギャングの一団。P.422参照。"],
            [78..83, "ソロの一団 ＞ PCグループの半分の人数のソロの一団。P.422参照。"],
            [84..90, "ブースターギャング ＞ ピラーニャズというブースターギャングに所属する、程度の低いストリート・パンクの一団。人数はPCより2人多い。P.422参照。"],
            [91..93, "メジャー級の犯罪者 ＞ PCは悪名高いスカガッタリア・ファミリーの大きな仕事の真っただ中に迷い込んだ。P.422参照。"],
            [94..100, "銃撃戦 ＞ すげえ。PCはちょうどメイルストロームとレッド・クローム・レギオンが繰り広げる大規模な抗争の真っ只中に迷い込んでしまった。P.422参照。"]
          ]
        ),
        ...
        "MKTE" => NIGHT_MARKET_FOODS_TABLE,
        "MKTD" => NIGHT_MARKET_MECHANIC_TABLE,
        "MKTW" => NIGHT_MARKET_WEAPONS_TABLE,
        "MKTC" => NIGHT_MARKET_CYBERWARE_TABLE,
        "MKTF" => NIGHT_MARKET_FASHION_TABLE,
        "MKTS" => NIGHT_MARKET_SUVIVAL_TABLE,
        "MKTT" => DiceTable::Table.new(
          "ナイトマーケット(分類のみ)",
          "1D6",
          [
            "食品とドラッグ ＞ 加工食品、生野菜、生きた動物、そして時には”新鮮な”ストリート・ドラッグ。",
            "個人用電子機器 ＞ ガジェットや機器が山ほど。特に怪しい店を当たればブラックICEすら見つかるかもな。",
            "武器と防具 ＞ ストリートに混沌を巻き起こすために必要なすべて。",
            "サイバーウェア ＞ ストリートで最高のサイバーテク。盗品でも死体からの回収品でもないはずだ。P.337参照。",
            "衣料品とファッションウェア ＞ ストリートで最新流行のファッションが一か所に集まっている。アクセントが欲しけりゃクロームメッキした品もあるぞ。ファッションウェアは夜の市でインストール可能だ。",
            "サバイバル用品 ＞ ”赤の時代”を生き延びるために必要な実用品のすべて。"
          ]
        ),
        "MKTK" => DiceTable::ChainTable.new(
          "ナイトマーケット表",
          "1D6",
          [
            NIGHT_MARKET_FOODS_TABLE,
            NIGHT_MARKET_MECHANIC_TABLE,
            NIGHT_MARKET_WEAPONS_TABLE,
            NIGHT_MARKET_CYBERWARE_TABLE,
            NIGHT_MARKET_FASHION_TABLE,
            NIGHT_MARKET_SUVIVAL_TABLE
          ]
        ),
