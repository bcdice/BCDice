      ...
      TABLES =
        {
          'LE' => {
            name: "失う感情表",
            type: '1D6',
            table: ['喜：喜びは消えた。嬉しい気持ちとは、なんだっただろう。', '怒：激情は失われ、憎しみもどこかへと消える。', '哀：どんなに辛くても、悲しさを感じない。どうやら涙も涸れたらしい。', '楽：もはや楽しいことなどない。希望を抱くだけ無駄なのだ。', '愛：愛など幻想……無力で儚い、役に立たない世迷い言だ。', '感：なにを見ても、感動はない。心は凍てついている。'],
          },

          'ESH' => {
            name: "「喜」の感情後遺症表",
            type: '2D6',
            table: ['日々喜びを求めてしまう。', '日々喜びを求めてしまう。', '嬉しい時間が長続きしない。', '素直に喜びを共有できないことがある。', '小さなことで大きく喜びを感じる。', '小さなことで大きく喜びを感じる。', '影響なし。', '影響なし。', '「喜」の後遺症をひとつ消してもよい。', '「喜」の後遺症をひとつ消してもよい。', '「喜」の後遺症をひとつ消してもよい。'],
          },

          'ESA' => {
            name: "「怒」の感情後遺症表",
            type: '2D6',
            table: ['始終不機嫌になる。', '始終不機嫌になる。', '一度怒ると、なかなか収まらない。', '怒りっぽくなる', '怒りかたが激しくなる。', '怒りかたが激しくなる。', '影響なし。', '影響なし。', '「怒」の後遺症をひとつ消してもよい。', '「怒」の後遺症をひとつ消してもよい。', '「怒」の後遺症をひとつ消してもよい。'],
          },

          'ESS' => {
            name: "「哀」の感情後遺症表",
            type: '2D6',
            table: ['一度涙が出るとなかなか止まらない。', '一度涙が出るとなかなか止まらない。', '夜、哀しいことを思い出して目が覚める。', '不意に哀しい気持ちになる。', '涙もろくなる。', '涙もろくなる。', '影響なし。', '影響なし。', '「哀」の後遺症をひとつ消してもよい。', '「哀」の後遺症をひとつ消してもよい。', '「哀」の後遺症をひとつ消してもよい。'],
          },

          'ESP' => {
            name: "「楽」の感情後遺症表",
            type: '2D6',
            table: ['突然陽気になったり、不意に笑い出してしまう。', '突然陽気になったり、不意に笑い出してしまう。', '周りが楽しくなさそうだと不安になる。', '楽しいことがないと落ち着かない。', '些細なことでも笑ってしまう。', '些細なことでも笑ってしまう。', '影響なし。', '影響なし。', '「楽」の後遺症をひとつ消してもよい。', '「楽」の後遺症をひとつ消してもよい。', '「楽」の後遺症をひとつ消してもよい。'],
          },

          'ESL' => {
            name: "「愛」の感情後遺症表",
            type: '2D6',
            table: ['少しでも気になる相手に愛を求めてしまう。', '少しでも気になる相手に愛を求めてしまう。', '愛する相手（恋人・家族・ペット・空想）から離れたくない。', '誰彼構わず優しくしてしまう。', 'ひとりでいると不安を感じる。', 'ひとりでいると不安を感じる。', '影響なし。', '影響なし。', '「愛」の後遺症をひとつ消してもよい。', '「愛」の後遺症をひとつ消してもよい。', '「愛」の後遺症をひとつ消してもよい。'],
          },

          'ESE' => {
            name: "「感」の感情後遺症表",
            type: '2D6',
            table: ['感動を共有できない相手を不信に思ってしまう。', '感動を共有できない相手を不信に思ってしまう。', '嬉しくても哀しくてもすぐに涙が出る。', 'リアクションがオーバーになる。', 'ちょっとしたことで感動する。', 'ちょっとしたことで感動する。', '影響なし。', '影響なし。', '「感」の後遺症をひとつ消してもよい。', '「感」の後遺症をひとつ消してもよい。', '「感」の後遺症をひとつ消してもよい。'],
          },
