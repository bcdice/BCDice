  ...
  module GameSystem
    class StellarLifeLife < Base
      ...
      def eval_game_system_specific_command(command)
        ...
        when 'RNST'
          return get_randomnpcship_table.roll(@randomizer)
        when 'RET'
          return get_randomevent_table.roll(@randomizer)
        when 'TRST'
          return get_treasurespec_table.roll(@randomizer)
        when 'TRAT'
        ...
        when 'ENT'
          return get_sfentertainment_table.roll(@randomizer)
        when 'CUT'
          return get_sfculture_table.roll(@randomizer)
        when 'NAT'
          return get_sfnature_table.roll(@randomizer)
        when 'INT'
          return get_sfinterior_table.roll(@randomizer)
        end
