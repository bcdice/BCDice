class BCDice::CommonCommand::BarabaraCountDice::Parser
  token NUMBER B R U C F S PLUS MINUS ASTERISK SLASH PARENL PARENR
...
require "bcdice/common_command/barabara_count_dice/node"
