...
INFO_MESSAGE_TEXT
  ...
  def get_conversation_horror_table
    table = [
             ...
             "指定特技：殴打\n地面に横たわった相手を見ながら、あなたは冷や汗が背中に伝うのを感じていた。相手は倒れたまま、不自然に体をねじ曲げて、ぴくりとも動かない。じわじわと血溜まりが広がっていく……。―殺してしまった。動揺して瞬きしたとき、相手の体は消えていた。血溜まりもなくなっている。あなたは茫然と立ちすくむ。幻覚だったのだろうか……？",
             ...
             "指定特技：拷問\n会話の最中、血の味を感じた。同時に、口の中にごろごろした違和感を覚える。相手が真っ青になってあなたの顔を指さす。どうしたのか尋ねようと口を開くと、ぽろりと何かが地面に落ちた。見下ろすと、血溜まりの中に白々と、あなたの歯が一本落ちていた。",
             "指定特技：人類学\n会話の最中、視界に違和感を覚えて、あなたは瞬きする。相手の顔が、変になっていた。引き延ばして、かき回したように、グロテスクに歪んでいる。えっ？と思ってよく見るが、歪みは変わらない。相手は全く気付いていないようだ。きつく目を瞑ってから見直すと、ようやく歪みは消えた。君の心に一つの疑いが生まれる。目の前の相手は、本当に人間なのだろうか？",
            ]
        return get_table_by_1d6(table)
  end
  ...
  def get_ville_horror_table
    table = [
             "指定特技：乗物\nキキィーッ！激しいブレーキ音、そして鈍い音。はっとして振り返ると、止まった車と、その前に倒れている人が目に入った。交通事故だ！慌てて駆け寄り、被害者の顔を見た途端、あなたは凍りついた。倒れているのは、あなただった。―えっ！？驚いて瞬きすると、路上のあなたも、車も消えていた。",
             "指定特技：情景\n通りすがりの家の屋根に誰かが立っている。あんなところで何を……？その誰かは踊りを踊っているように見えた。手足を振り回し、頭を激しく動かして、踊っている。尋常な様子ではない。狂ったように踊っている。見ているうちにものすごく不吉な気分になってきた。見たくないのに、どういうわけか、目をそらすことができない。不吉な予感はどんどん強くなってくる……。",
             "指定特技：終末\nウゥゥゥゥゥゥゥゥ…………　街にサイレンが鳴り響く。どこで鳴っているのか、いつまで鳴っているのか。こんなに大きな音なのに、どうして誰も騒がないのだろう。不思議に思って歩いていると、道の向こうから歩いてくる人影がある。怪我をしているのか、よろめいて、今にも倒れそうになりながら、がくり、がくりと不自然な歩き方で近づいてくる。あれはいったい………？",
             "指定特技：脅す\n歩いていると、不意に静かになった。あたりを見渡すと、人も車も誰もいない。無人の街が、どこまでも広がっている。さっきまでたくさん人がいたのに……！？「おい！何やってるんだ！」突然怒鳴られてぎくりとする。振り返ると、作業着をきた男性がこっちへ走ってきていた。「馬鹿野郎！こんなところに来たらー」最後まで聞かないうちに、不意に音が戻ってきた。人と車が行き交う、元通りの街だ。今のは何だったんだ……？",
             "指定特技：混沌\n電柱の根元に、女性がうずくまっている。お腹を押さえてうずくまっている。お腹を押さえて、苦しそうに顔を伏せている。「大丈夫ですか？」近づいて声をかけたあなたに、女性は頷いた。「はい―ありがとうございます。」そう言って顔を上げた女性の顔には、何もなかった。つるりとした剥き玉子のような皮膚が続いているだけだった。うわっ！？のけぞった途端、意識が遠ざかって、気が付くとあなたは電柱の根元にうずくまっていた。",
  ...
  def get_inattendu_horror_table
    table = [
             "指定特技：驚き\nバタバタバタッ！突然の物音に、あなたはぎょっとして振り仰ぐ。天井裏を何かが動き回っているようだ。動物が入り込んだのだろうか？それにしては大きい音だ。――まるでこどもがめちゃくちゃに走り回っているような。物音は一瞬止まり、すぐに再開した。ドン！ドン！ドン！ドン！飛び跳ねるような音がするのは、ちょうどあなたの真上だ……。",
             "指定特技：宇宙\n窓から光が差し込む。窓に目を向けてみると、白く輝く巨大な飛行物体が浮かんでいた。見せられたように見つめると、鳥や飛行機とは思えないような、激しく不規則な動きで飛び回り始めている。なんだろう、あれは？不思議に思っていると、背後から誰かがささやいた。「あれは………だよ。」はっと気づくと、いつの間にか、全く違う場所にいた。手のひらに何か埋まっているような硬い感触がある……。",
             "指定特技：におい\n奇妙な荷物が届いた。ガムテープでぐるぐる巻きにされた大きな段ボールだ。差出人名を書いた紙が貼ってあるが、滲んでしまって読めない。箱の中身は土だった。陶器のかけらや石ころが混ざった、変な臭いのする土が入っていた。わけがわからないので中身は捨てたが、それ以降なんだかツキが落ちている気がする……。",
             "指定特技：我慢\n壁の向こうから誰かが話している声が聞こえてくる。「……だから。こいつは……しないと。」「そうね……わいそ……さなきゃ。」ぼそぼそ、ぼそぼそと、陰気な調子で会話は続く。何を話しているのか、内容はよくわからないが、なんとなく自分のことを言われているようで薄気味が悪い。気になって壁に耳を当てた時、はっきりした声が、壁の向こうからこう言った。「……ねえ、ちゃんと聞いてる？」",
             "指定特技：手触り\nぽたり。ぽたり。首筋に落ちた生暖かい水滴の感触に、あなたは眉を寄せた。気が付くと机の上に赤い雫が落ちている。鉄臭いにおいが鼻を突く。ぽたり。ぽたり。ぽたり。雫は勢いを増し、次々と落ちてきて、机の上に広がってゆく。ゆっくりと見上げると、天井には大きく赤黒いしみが広がっていた。ぽたり。ぽたりぽたり。ぽたり。――ぼたぼたぼたっ！高まる水音にあなたは立ちすくむ。天井裏に、いったい何が……？",
             "指定特技：地底\n見慣れたはずの場所に、見慣れない扉を見つけた。開けてみると、長い下り階段が闇の中に伸びている。不審に思って下りてみると……そこは地下室だった。こんな場所があっただなんて。明かりを片手に進んでいくと、何かが近づいてくる気配がする。闇の中から、何者かが、あなたの名を呼んだ。",
            ]
  ...
  def get_ruines_horror_table
    table = [
             "指定特技：暗黒\n重く頑丈そうな扉を開ける。部屋の中は真っ暗だった。灯りで照らしてみると、別の部屋へと続く道が何本か見つかった。目ぼしいものはなさそうだ。一旦、入り口に戻ろうと、入ってきた扉のほうを振り返る。そこには壁しかなかった。あの重厚な扉がなくなっている。そんな馬鹿な。しかし、何度探してもどの壁にも扉らしきものは見当たらない。仕方なく、通路を進むことにしたが、じわじわと不吉な気分が込み上げてくる。……あの扉は、開けてはいけなかったのではないか？",
             "指定特技：整理\nあなたは廃墟の中、ブーン……という低い音に気付いた。冷蔵庫だ。どこから電気が来ているのか、白い冷蔵庫が廃屋の片隅にひっそりと佇んでいる。がちゃりと扉を引き開けてみたあなたは、中にいた何かと、目があった。……気が付くと、あなてゃ暗くて冷たいところで体を丸めている。ブーン…という音が聞こえている。ここは涼しくて、狭くて――とても居心地がいい。",
             "指定特技：追跡\n廃屋のふすまを開けたとき、あなたは強い違和感を覚える。分厚くホコリが積もったその部屋には、濃厚な気配が漂っていた。ちゃぶ台の上には中身の残った湯飲み。さっきまで誰かが座っていたみたいに凹んだ座布団。なぜこの茶の間には、こんなに生活感があるのだろうか……。",
             "指定特技：愛\n廃墟を歩いていると、突然、あなたの携帯に電話がかかってきた。静まりかえった廃墟に鳴り響く着信音に肝をつぶしつつも出てみると、電話の向こうから、あなたの祖母がいきなり叱りつけてきた。「あんた！何やってんの！そんなとこ行ったらダメでないの！」え？なぜ祖母が……？「早くそこから出なさい！大変なことになるよ！」わけがわからずに口ごもっているうちに、電話は切れた。ディスプレイには「圏外」と表示されていた。",
             ...
             "指定特技：薬品\n不意に、シンナーの匂いが鼻を刺した。廃墟の壁にべったりと、赤いペンキの文字が書かれている。何が書いてあるのかは判然としないが、ひたすら悪意と憎しみを塗り込めたようなタッチにおぞけが走る。そのうちあることに気付いて、あなたは総毛だった。ペンキがまだ新しい。……塗り立ての様に新しいのだ。",
            ]
  ...
  def get_Mlle_horror_table
    table = [
             "指定特技：痛み\nブ―――――――ン耳元で甲高い羽音が響いてくる。見たことのない真っ赤な羽虫の群れが飛んでいた。ブ―――――――ン羽虫を追い払うように、腕を振るう。痛いっ。腕に刺すような痛みが走った。ブ―――――――ン虫たちは、どこかへ去っていく。みるみる腕の表面に不気味な水疱がぽつぽつと浮かび上がってきた。",
             "指定特技：夢\n木々の間で、何か大きなものが動いているのが見える。肉の腐ったような臭いがぷんと鼻を突く。まだら模様のあれは……毛皮？それとも、ずたずたになった服の切れ端。そいつがあなたを見た。木の葉の合間から除く目は、まるで人のような―――目があった瞬間から記憶がない。気が付くと、人の髪に似た黒い毛が、あなたの全身に付着していた。",
             "指定特技：恨み\n林の中で出くわした大樹の幹には、たくさんの藁人形が釘で打ち付けられていた。うわあ、と思いながら見上げるうちに、気のめいる事実に気付いてしまった。新しめの藁人形の一つに、名前の書かれた札が貼り付けられている。―――ひどく、見覚えのある名前だった。",
             "指定特技：深海\n……おーい。……お―――い。遠く、呼ぶ声を聴いた気がして、波の合間に目を凝らす。つるりとした黒い影が、浮きつ沈みつ、あなたを差し招いてくる。ひい、ふう、みい、よう……七人。七人の黒い影が、波間から、あなたに手を振っている。―――なんだか、頭がぼうっとしてきた。",
  ...
  def get_latence_horror_table
    table = [
             "指定特技：味\nのどの渇きを覚えた。調べ物を開始した時間から、時計の針は大分進んでいる。どうやら根を詰め過ぎたようだ。画面に目を戻しつつ、ペットボットルの水を口に含む。すると、口内に違和感が広がった。たまらず水を吐き出す。すると、真っ黒い液体が机の上の資料を汚した。口の中には、ドブ川のような臭いがこびりついている。確認したペットボトルの水は、透明なのだが……？",
             "指定特技：カメラ\n資料の間から、黄ばんだ封筒に入った写真の束が出てきた。被写体は……あなただ。知らないうちに撮られた、あなたの写真が、何十枚も束ねられている。色あせた写真を無造作に止めた輪ゴムは劣化してねばついていた。――だれが、こんな写真を？何の目的で……？",
             ...
             "指定特技：民俗学\n資料を漁るうちに、ある寒村に伝わるおぞましい風習に辿り着いた。暴力……儀式……生贄……。とてもまともな人間のやることとは思えない所業に震えあがる。その風習には、なぜか既視感があった。どこで読んだんだろう？考えるうちに、ある記憶が蘇った。あなたの幼い頃の記憶だった。いや……そんな、馬鹿な。あなたの故郷が、こんな寒村のはずはない……。",
  ...
  def get_overtime_horror_table
    table = [
             "指定特技：死\n窓に目をやったとき、窓の外を落下する人影と目があった！慌てて窓辺に駆け寄るが、下には何もない。幻覚だったのだろうか……？",
             "指定特技：機械\n突然、コピー機が唸りを上げて紙を吐き出し始めた。床に舞い散ったコピー用紙には、ゆがんだ人の顔のようなものが印刷されている。気味が悪い……。",
             "指定特技：物陰\n青白い子供が机の下からあなたを見上げている。うわっ！と叫んで飛び退くと、子供の姿は消えた。",
             "指定特技：手触り仕事をしていると、背後から長い黒髪が垂れ下がってきた。女の長い黒髪だ。……後ろで覗き込んでいるのは、一体誰だ？",
  ...
  # 残業シーン表
    def get_overtimework_scene_table
        table = [
                 ...
                 "突如携帯電話の音が鳴り響く。マナーモードにしていたはずなのに……。一体、誰からだろうか？",
                 "不意の機械音に驚いてみると、ファックスが紙を吐き出している。こんな時間に何だろう？",
                 "美味しそうな香りが漂ってきて、急に空腹を感じる。どこから来たんだ、この匂いは？",
                 "気分転換に見ていたネットに夢中になって、ふと気付くと何分も経過……いかんいかん。",
                 "ガクンと船をこいで、はっと目を覚ました。慌てて時計を見る……えっ、もうこんな時間なの！？",
                ]
    return get_table_by_2d6(table)
  end
