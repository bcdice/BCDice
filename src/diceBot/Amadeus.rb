...
寵愛。あなたは、その資質や才能を親神に見いだされました。そして、夢の中で親神と出会い、＜神の血＞を直接与えられました。それ以来、あなたは不思議なものが見えたり聞こえたりするようになりました。
...
心に大きな乱れが生まれる。自分の属性に対応した変調を受ける（黒なら絶望、赤なら憤怒、青なら臆病、緑なら堕落、白なら恥辱）。
周囲から活気が失われる。運命の輪のなかから、黒以外の領域のインガをすべて1つずつ減少する
},},
    ...
    "BT" => {
      ...
      :type => 'D66',
      :table => [
[11, "土着の怪物が襲いかかってきた！　なんとか撃退するが、傷を負ってしまった。自分は、1D6点のダメージを受ける。"],
[12, "美女の沐浴をのぞいてしまった。1D6を振ること。1～2なら「堕落」、3～4なら「恥辱」、5～6なら「重傷1」の変調を受ける。"],
[13, "強欲な商人に出会う。このシーンに登場したキャラクターは、買い物を行うことができる。ただし、通常の値段より価格が1高い。"],
...
[16, "あなたは、思わず歌を口ずさむ。いつの間にか、みんながその歌に聴き入っていた。黒以外の領域の好きなインガ1つを、別の領域に移動させる。"],
[22, "＜絶界＞の外の世界の友人のことを思い出す。みんなは元気にしているだろうか？　この出目を振ったプレイヤーのPCは、【日常】で判定を行うことができる。成功すると、自分の変調を1つ回復するか、黒の領域からインガを1つ取り除くことができる。"],
[23, "奇妙な商人に出会う。このシーンに登場したキャラクターは、買い物を行うことができる。"],
[24, "喋る動物にお願いことをされる。動物たちも、この神話災害で苦しんでいるようだ。あなたは、「この怪物の本体の【生命力】を0にする」という追加の【任務】を受けることができる。この【任務】を達成すると、追加で経験値を20点もらうことができる。"],
[25, "素敵な夢を見る。この出目を振ったプレイヤーは、自分のPC以外の好きなキャラクター1人に対する【想い】を1点上昇する。"],
[26, "大切な人から、あなたを心配するメールが届いていた。なんて返そう？　この出目を振ったプレイヤーのPCは、【日常】で判定を行うことができる。成功すると、自分の変調を1つ回復するか、自分の持つ【想い】のマークについたチェックを一つ消す。"],
[33, "親切な商人に出会う。このシーンに登場したキャラクターは、買い物を行うことができる。ただし、通常の値段より価格が1安い（価格1未満にはならない）。"],
...
[36, "食事をしながら、仲間と大いに語り合う。このシーンに登場して、食事を行ったキャラクターは、自分の持つ【想い】のマークについたチェックを一つ消す。"],
...
PC全員、自分の人物欄の中から、のチェックを1つ消すことができる。
},},
