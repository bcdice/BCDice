...
・致命傷表 FWT
・休憩表（〜BT）
  教室 RBT／購買 SBT／部室 BBT／生徒会室 CBT／学生寮 DBT／図書館 IBT／屋上 FBT／
　研究室 LBT／プール PBT／中庭 NBT／商店街 ABT／廃墟 VBT／ゲート GBT
・デート表（DATE）
...
#　研究室 L:Labo／プール P:Pool／中庭 N:iNner／商店街 A:Avenue／廃墟 V:deVastation／ゲート G:Gate
  ...
  def getClassRoomBreakTable
    name = '教室'
    table = [
             "風紀委員の巡回！\n「そこ、何やってる！」風紀委員に見つかった。現在が真夜中パートであれば、こっぴどくしかられる。〔政治力〕で判定を行う。失敗すると、次のパートは行動できない。真夜中パート以外であれば、心身ともにリフレッシュ。《アウル》が1点回復する。",
             ...
             "クラスの噂\n「ねぇねぇ、これ知ってる？」クラスメイトの噂話……。〔政治力〕の判定を行う。成功すると、手がかり一つを選び、その情報を公開する。失敗すると、あなたについての噂をたてられる。あなたの周囲に、あなたに対して《感情値》を持つキャラクターがいたら、それを判定させる。",
             "ラブレター!?\n「こ、これは……ッ!?」机の中に何かを発見。〔青春力〕で判定を行う。成功すると、誰かからのラブレターを発見！好きなNPC一人を選び、そのキャラクターの自分に対する《感情》が1点上昇し、属性を《好意》にする。",
  ...
  def getSchoolStoreBrakeTable
    name = '購買'
    table = [
             "風紀委員の巡回！\n「そこ、何やってる！」風紀委員に見つかった。現在が授業パートであれば、こっぴどく叱られる。〔政治力〕で判定を行う失敗すると、次のパートは行動できない。授業パート以外であれば、心身ともにリフレッシュ。《アウル》が1点回復する。",
             ...
             "デリバリー\n「あー、今は品切れだね。補充したらとどけるよ」好きなアイテムを一つ選ぶ。そのアイテムの調達の判定を一度行うことができる。調達の判定に成功すると、そのアイテムを次のパート以降、好きなタイミングで入手することができる。",
             "サイフ紛失\n「あれ？あれれれれッ!?」サイフを落としてしまった。【お金】を持っていたら、それを全て失う。",
            ]
    getBreakTable(name, table)
  end
  ...
  def getClubRoomBrakeTable
    ...
    table = [
             ...
             "後輩現る！\n「どこまでもついていきますよ先輩!」いつのまにか可愛い後輩ができていた。もしも【クラブ】のコミュを習得していたら、アイテムの【後輩】一つを獲得する。",
             "先輩現る！\n「おう、差し入れもって来たぞ!」先輩がやってくる。アイテムの「ごちそう」を一つ獲得する。",
             "青春の汗\n「ダハハハ！青春の汗を流そうぜ！」部室の中から体育会系部員の熱い会話が聞こえてきた。好きな能力値で判定を行う。成功すると、このセッションの間、〔青春力〕の修正が1点上昇する。失敗すると「バカ」の変調を受ける。",
             "茶飲み話\n「まぁまぁ。お茶でも飲んでいきなよ」知り合いの所属する部室でお茶を飲む。〔政治力〕の判定を行う。成功すると、《アウル》が1点回復する。",
             "熱い議論「もっと本質的な部分に目を向けようよ！」部室の中から文科系部員の高度な会話が聞こえてきた。好きな能力値で判定を行う。成功すると、このセッションの間、〔学力〕の修正が1点上昇する。失敗すると「孤独」の変調を受ける。",
             "マネージャー\n「あれ？ケガしてるじゃないですか」もしも【クラブ】のコミュを習得していたら、可愛いマネージャーが絆創膏をくれる。《生命力》が1D6点回復する。",
             "突然の料理\n「ちょっと付き合えよ」もしも【クラブ】のコミュを習得していたら、仲間の部員に呼び止められる。〔政治力〕で判定を行う。成功すると、自分の放課後欄の中から好きな【クラブ】一つを選び、□にチェックを入れる。",
             "仲間の告白\n「キミ、最近なんかイイカンジだよね」もしも【クラブ】のコミュを習得していたら、部室にいるキャラクターの中から好きなものを一人選び、そのキャラクターの自分に対する《感情値》が1点上昇する（部室に誰がいるのかは、最終的にGMが決定する事）",
  ...
  def getStudentCouncilBrakeTable
    ...
    table = [
             ...
             "同僚との遭遇\n「こんなとこで何してんの？」もしも【委員会】のコミュを習得していたら、仲間の委員に呼び止められる。〔政治力〕で判定を行う。成功すると、自分の放課後欄の中から好きな【委員会】一つを選び、□にチェックを入れる。",
             "旧友との再会\n「おう！久しぶりッ!!」昔の友人とばったり再会。〔青春力〕の判定を行う。成功すると、昔貸してくれた本を返してくれる。アイテムの【参考書】を一つ獲得する。",
  ...
  def getDormitoryBrakeTable
    ...
    table = [
             ...
             "恋の相談\n寮の友人から恋人に関する相談を受ける。もしも【恋人】のコミュを習得していたら、《アウル》が2点回復する。習得していなかったら「孤独」の変調を受ける。",
  ...
  def getLibraryBrakeTable
    ...
    table = [
             ...
             "天魔対策\n「アイツの習性は……」天魔の事を調べる。天使か悪魔のエネミー一覧を選んで、〔学力〕の判定を行う。成功すると、そのセッションの間、そのエネミーの攻撃に対して、ガード判定を行う場合、その達成値が2点上昇する。",
             "物語の世界へ\n「…………」シーンと静まり返った雰囲気の中、読書が進む。本の中にどんどん入り込んでいく。すべての変調が回復し、「空腹」の変調を受ける。",
             "本の貸し出し\n「へー、こんな本もあるんだ」アイテムの【週刊誌】か【参考書】のいずれか一つを獲得する。",
             "授業の予習\nせっかく図書館に来たので、気になっていた科目について調べる。〔学力〕で判定を行う。成功すると、疑問点が解消される。自分の授業欄から好きなものを一つ選び、□にチェックを入れる。",
  ...
  def getRoofBrakeTable
    ...
    table = [
             ...
             "嵐の予感\n雲の動きが早くなっている。吹き荒ぶ風に、嵐の予感を感じた。〔青春力〕で判定を行う。成功すると、そのセッションの間、《アウル》の限界値が1点上昇する。失敗すると雨に吹かれて風邪をひいてしまう。「病気」の変調を受ける。",
  ...
  def getLaboratoryBrakeTable
    ...
    table = [
             ...
             "試薬\n「この試薬を飲んでみてくれないか」毒々しい色のポーションを渡される。「政治力」で判定を行う。失敗すると、断りきれずそれを飲むハメになる。。1D6を振る。奇数が出ると、そのセッションの間、その防具の装甲が1上昇する。偶数が出ると、その防具は破壊される。",
             "爆発事故\n「逃げろー！」研究室から数人の生徒が逃げ出してくる。なにかヤな予感。〔青春力〕で判定を行う。失敗すると、実験の爆発に巻き込まれる。2D6点のダメージを受ける。",
             ...
             "装甲安定実験\n「ほう。面白い防具を使っているようだな」白衣を着た怪しげな生徒が防具の改造を申し出る。申し出を受け入れるなら、自分のもっている好きな防具一つを選んで、1D6を振る。奇数が出ると、そのセッションの間、その防具に「堅牢２」の特殊効果が加わる（すでに「堅牢」の特殊効果のある武器は、その値が２上昇する）。偶数が出ると、その防具は破壊される。",
  ...
  def getPoolBrakeTable
    ...
    table = [
             "風紀委員の巡回！\n「そこ、何やってる！」風紀委員に見つかった。現在が授業パートであれば、こっぴどく叱られる。〔政治力〕で判定を行う。失敗すると、次のパートは行動できない。授業パート以外であれば、心身ともにリフレッシュ。《アウル》が1点回復する。",
             "熱いシャワー\n「……ふぅ」プールから出て、暖かいシャワーで冷えたからを暖める。疲れが少しずつほぐれていく。《生命力》が1D6点回復する。",
  ...
  def getInnerCourtBrakeTable
    ...
    table = [
             ...
             "犬登場\n「ワンワンワン！」不思議な犬がグラウンドに現れる。ここを掘れと言っているようだが……。1D6を振ること。奇数なら、地面にはお金が埋まっていた【お金】を一つ獲得す。偶数なら、低級の天魔が封印されていた。「学力」で判定を行う。失敗すると3D6点のダメージを受ける。",
             "観戦中\nグラウンドで行われている撃退士同士の特訓風景を眺めている。踏む。なるほどなぁ……。〔学力〕で判定を行う。成功すると、自分の授業欄の中から好きなものを一つ選び、□にチェックを入れる。",
             "占い師\n「そこのあなた。死相がでています。」そう言って、占い研のメンバーに呼び止められる。〔政治力〕の判定を行う。成功すると、危機を回避する方法を占ってもらうことができる。次に自分が判定で大失敗したとき、その判定のサイコロを1度だけ振り直すことができる。",
             "屋台\nお弁当屋さんや屋台が軒を並べている。美味しそうな匂いが漂ってきた。〔政治力〕の判定を行う。成功すると、色々な食事を食べて、《生命力》が1D6点と「空腹」の変調が回復する。",
             "特訓参加\n「おい、そこのお前！お前も一緒にやれ！」授業中の先生に、無理やり授業に参加させられる。ひたすら攻撃を避けまくる。不は。疲れたー。《生命力》が2D6点減少し、そのセッションの間、《生命力》の限界値が減少した《生命力》と同じ値だけ上昇する。",
             "落し物\nあれ？こんなものが落ちてる。１なら【タバコ】、２なら【情報誌】、３なら【お洒落グッズ】、４なら【参考書】、５なら【阻霊符】、６なら【タリスマン】を一個獲得する。",
             "突然の告白！\n「先輩、ずっと前から憧れてました！」そう言って、後輩が告白して来た。江？ええッ!?突然の事に頭が真っ白になってしまった。好きな異性のキャラクター一人を選ぶ。そのキャラクターの自分に対する《感情値》が2点上昇する。その後、〔青春力〕で判定を行う。失敗すると「バカ」の変調を受ける。",
             "鉄球飛来！\n「おーい！危ないぞーッ!!」陸上部の投げた砲丸が飛んでくる。〔青春力〕で判定を行う。失敗すると2D6点のダメージを受ける。",
  ...
  def getShoppingAvenueBrakeTable
    ...
    table = [
             "風紀委員の巡回！\n「そこ、何やってる！」風紀委員に見つかった。現在が授業パートであれば、こっぴどく叱られる。〔政治力〕で判定を行う。失敗すると、次のパートは行動できない。授業パート以外であれば、心身ともにリフレッシュ。《アウル》が1点回復する。",
             "自習\nファーストフード店でレポート執筆。……あまり進まないなぁ。〔学力〕で判定を行う。成功度を2以上獲得すると、レポートは完成。自分の授業欄から好きなもの一つを選び、□にチェックを入れる。",
             "立ち話\n「よう。寄ってかないかい！」店の主人が陽気に声をかけてくる。〔政治力〕で判定を行う。成功すると、気になる話を聞かせてくれる。成功すると、手がかり一つを選び、その情報を公開する。失敗すると、退屈な話に付き合わされる。「眠気」の変調を受ける。",
  ...
  def getDevastationBrakeTable
    name = '廃墟'
    table = [
             "迷子\n「きゃーーー！」少女がディアボロに襲われている。〔青春力〕で判定を行う。成功すると、少女を助けて感謝される。少女の自分に対する《感情値》が3点上昇し、その属性が《好意》になる。失敗すると、少女は命は取り留めたものの、傷つき倒れてしまう。2D6点のダメージと「孤独」変調を受ける。",
             "ライバル登場？\n「一度、お前と手合わせしてみたかったんだよ」撃退士らしき見覚えある人物が現れる。好きなＮＰＣを一人選び、そのキャラクターの自分に対する《感情値》が1点上昇する。",
             "無人の部屋\n「…………」誰もいないはずなのに、何かの気配がする。イヤな感じだ。〔青春力〕で判定を行う。成功すると、視線の正体を発見する。それはかわいい子猫だった。あまりのかわいさに《アウル》を1点回復する。失敗すると「恐怖」の変調を受ける。",
             ...
             "怪しげな男\n「いいものがあるぜ。欲しいかい？]怪しげな男が【ポーション】を打っている。アイテムの【ポーション】の調達の判定を一度行うことができる。この【ポーション】の価格は3になるが、回復する《生命力》は3D6になる。",
             ...
             "不良撃退士\n「方。いいもの持ってるじゃないか。そいつを寄こしたら見逃してやるよ］自分の携行品の中で一番価格の高いものを一つ選ぶ。それを渡せば特に何も起こらない。もし渡すのを断るのなら、〔青春力〕で葉判定を行う。成功度が2以下だった場合、3D6点のダメージを受ける。",
            ]
    getBreakTable(name, table)
  end
  ...
  def getGateBrakeTable
    name = 'ゲート'
    table = [
             "尋問\nゲート内にひそんでいた点らから情報を収集する。〔政治力〕の判定を行う。成功すると、このシナリオに登場する可能性のある天魔の種類すべてをＧＭから教えてもらえる。失敗すると、1D6点のダメージを受ける。",
             "計略\n敵の計略に掛かる。〔政治力〕で判定を行う。失敗すると、ＧＭは手がかり一つを選ぶ。その手がかりの必要性高度が1上昇する。この効果は累積しない。",
             ...
             "不意打ち\n「……荒れは、もしや？］ゲートの中で、恐ろしい程の殺気の持ち主を見つける。もしや、今回の事件の黒幕か？彼に不意打ちを仕掛けることができる。不意打ちを仕掛けるなら〔青春力〕の判定を行う。成功すると、そのシナリオの黒幕（ボス）に［判定成功度×1］D6点のダメージを与える事ができる。失敗すると、3D6点のダメージを受ける。",
             "捜索\nゲート内を捜索する。〔学力〕で判定を行う。成功すると、「初期アイテム決定表」を一度使用し、そのアイテム一個を獲得する。失敗すると、1D6点のダメージを受ける。",
             "戦友\n一緒にてきっ戦う内に、絆が芽生えてくる。〔青春力〕で判定を行う。成功すると、ゲートにいるキャラクターの中から好きなものを一人選ぶ。自分とそのキャラクターは、お互いに対する《感情値》が1点上昇する（ゲートに誰がいるのかは、最終的にＧＭが決定すること）。失敗すると1D6点のダメージを受ける。",
  ...
  def getBattleFieldTable
    ...
    table = [
             "平地。\n特に特殊効果はない。",
             "罠。\n落とし穴やセキュリティー装備など、無数の罠が仕掛けられた戦場。この戦場にいるキャラクターは、ダメージを受けたとき、速度によるダメージ修正が2倍になる。",
             ...
             "力場。\n展開や魔界の影響を受けている戦場。この戦場にいるキャラクターは、ラウンドの終了時に速度0にいると、〔学力〕の判定を行うことができる。成功すると、《アウル》を1点獲得できる。",
  ...
  def getFatalWoundsTable
    ...
    table = [
             ...
             "大きな傷を負う。行動不能になる。",
             "凄まじい一撃に意識を失う。\n《生命力》が0点になり、行動不能になる。",
             "一瞬、気を失う。\n行動不能になる。1D6ラウンド後の「ラウンドの終了時」、もしくは、戦闘終了時に《生命力》が1点まで回復する（1D6ラウンドが経由するまでに、すでに《生命力》が1点以上に回復していた場合は、この効果は無効になる）。",
             "凄まじい幸運。\nそのシーンに自分に《好意》を持っているキャラクターがいたら、代わりにそのキャラクターがダメージを受けることができる（ダメージを代わりに受けるかどうかは、そのキャラクターを操るキャラクター、もしくはGMが決定する）。誰もダメージを代わりに受けなかった場合、行動不能になる。",
             ]
    getD6Table(name, table)
  end
  ...
  def getFumbleTable
    ...
    table = [
             ...
             "的の罠にかかる。自分の周りにいる、自分以外のすべての見方キャラクターは《生命力》を1D6点減少する。",
